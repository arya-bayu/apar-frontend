...
import { DownloadIcon, Loader2, Save, ScanLine } from 'lucide-react'
...
const InvoicePage = () => {
    ...
    if (!invoice) return <LoadingSpinner className="h-[calc(100dvh)] supports-[height:100svh]:h-[calc(100svh)] supports-[height:100cqh]:h-[calc(100cqh)]" size={36} />
                            ...
                            <Table>
                                ...
                                <TableFooter>
                                    ...
                                    <TableRow className="bg-zinc-50 font-medium text-zinc-900 dark:bg-zinc-900 dark:text-zinc-50 hover:bg-zinc-50/90 dark:hover:bg-zinc-800/90">
                                        ...
                                        <TableCell className="text-right">
                                            <EditText
                                                readonly={invoice.status !== 0 ? true : false}
                                                placeholder="0"
                                                type="number"
