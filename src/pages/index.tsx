...
export default function Home() {
  const { authUser } = useAuth({ middleware: 'guest' })
  ...
  return (
    <>
      ...
      <div className="bg-dots-darker dark:bg-dots-lighter relative min-h-screen bg-gray-100 bg-center selection:bg-red-500 selection:text-white dark:bg-gray-900 sm:flex sm:items-center sm:justify-center">
        <div className="text-rightk p-6 sm:fixed sm:right-0 sm:top-0">
          {authUser ? (
            <Link
              href="/dashboard"
        ...
        <div className="mx-auto max-w-7xl p-6 lg:p-8">
          ...
          <div className="mt-16">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
              <a
                ...
                className="duration-250 flex scale-100 rounded-lg bg-white from-gray-700/50 via-transparent p-6 shadow-2xl shadow-gray-500/20 transition-all focus:outline focus:outline-2 focus:outline-red-500 motion-safe:hover:scale-[1.01] dark:bg-zinc-950/50 dark:bg-gradient-to-bl dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/5"
              >
                <div>
          ...
          <div className="mt-16 flex justify-center px-6 sm:items-center sm:justify-end">
            <div className="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:ml-0 sm:text-right">
              CV. Indoka Surya Jaya
            </div>
          </div>
        </div>
      </div>
